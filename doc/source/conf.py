...
project = u'Cecilia5'
copyright = u'2013, Jean Piché, Olivier Bélanger'
...
latex_documents = [
  ('index', 'Cecilia5.tex', u'Cecilia5 Documentation',
   u'Jean Piché, Olivier Bélanger', 'manual'),
]
...
man_pages = [
    ('index', 'cecilia5', u'Cecilia5 Documentation',
     [u'Jean Piché, Olivier Bélanger'], 1)
]
...
texinfo_documents = [
  ('index', 'Cecilia5', u'Cecilia5 Documentation',
   u'Jean Piché, Olivier Bélanger', 'Cecilia5', 'One line description of project.',
   'Miscellaneous'),
]
